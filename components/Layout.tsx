...
const MASTER_ADMIN_LINKS = [
  ...
  { id: 'transport', path: '/admin/transport', label: 'Transport', icon: Bus },
  ...
  { id: 'genai', path: '/admin/gen-ai-tools', label: 'GenAI Tools', icon: Sparkles },
  ...
  { id: 'vendors', path: '/admin/vendors', label: 'Vendor Attachment', icon: Car },
...
const Layout: React.FC<LayoutProps> = ({ children, role, onLogout }) => {
  ...
  const userLinks = [
    ...
    { path: '/user/transport', label: 'Transport', icon: Bus },
    // Leads removed for employees
